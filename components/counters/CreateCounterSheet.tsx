...
export const CreateCounterSheet = forwardRef<BottomSheetModal, CreateCounterSheetProps>(
  function CreateCounterSheet({ counterId }, ref) {
    ...
    const handleDone = useCallback(async () => {
      ...
      if (isEditMode && counterId) {
        await updateCounter(counterId, { title: title.trim(), color });
      } else {
    ...
    }, [title, color, startDate, isEditMode, counterId, addCounter, updateCounter, ref]);
